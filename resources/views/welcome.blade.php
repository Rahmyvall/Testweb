...
<html lang="en">
    ...
    <head>
        ...
        <title>Test Wb & IT Support | Beranda</title>
    </head>
                ...
                <div class="menu-bg-wrap">
                    <div class="site-navigation">
                        <div class="row g-0 align-items-center">
                            <!-- Logo -->
                            <div class="col-2">
                                <a href="index.html" class="logo m-0 float-start">WebModular<span
                            ...
                            <!-- Kanan (Search + Login Button + Burger) -->
                            <div class="col-2 text-end d-flex align-items-center justify-content-end">
                                ...
                                <!-- Tombol Login -->
                                <a href="{{ route('login') }}" class="btn btn-primary btn-sm d-none d-lg-inline-block">
                                    <i class="bi bi-person"></i> Login
                                </a>

                                <!-- Tombol Login (mobile) -->
                                <a href="{{ route('login') }}"
                                    class="btn btn-primary btn-sm d-inline-block d-lg-none me-2">
                ...
                <div class="row align-items-stretch retro-layout">
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient">
                            ...
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_2_horizontal.jpg') }}');">
                            </div>
                        ...
                        <a href="single.html" class="h-entry v-height gradient">
                            ...
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_5_horizontal.jpg') }}');">
                            </div>
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry img-5 h-100 gradient">
                            ...
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_1_vertical.jpg') }}');"></div>
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient">
                            ...
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_3_horizontal.jpg') }}');">
                            </div>
                        ...
                        <a href="single.html" class="h-entry v-height gradient">
                            ...
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_4_horizontal.jpg') }}');">
                            </div>
                    ...
                    <div class="col-md-9">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="blog-entry">
                                    <a href="single.html" class="img-link">
                                        <img src="{{ asset('blogy/images/img_1_sq.jpg') }}" alt="Image"
                                            class="img-fluid">
                                    </a>
                                    <span class="date">Apr. 14th, 2022</span>
                            ...
                            <div class="col-md-6">
                                <div class="blog-entry">
                                    <a href="single.html" class="img-link">
                                        <img src="{{ asset('blogy/images/img_2_sq.jpg') }}" alt="Image"
                                            class="img-fluid">
                                    </a>
                                    <span class="date">Apr. 14th, 2022</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="blog-entry">
                            <a href="single.html" class="img-link">
                                <img src="{{ asset('blogy/images/img_1_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid">
                            </a>
                            <span class="date">Apr. 14th, 2022</span>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="blog-entry">
                            <a href="single.html" class="img-link">
                                <img src="{{ asset('blogy/images/img_2_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid">
                            </a>
                            <span class="date">Apr. 14th, 2022</span>
                            <h2><a href="single.html">Startup vs corporate: What job suits you best?</a></h2>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="blog-entry">
                            <a href="single.html" class="img-link">
                                <img src="{{ asset('blogy/images/img_3_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid">
                            </a>
                            <span class="date">Apr. 14th, 2022</span>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="blog-entry">
                            <a href="single.html" class="img-link">
                                <img src="{{ asset('blogy/images/img_4_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid">
                            </a>
                            <span class="date">Apr. 14th, 2022</span>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_7_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start"><img
                                            src="{{ asset('blogy/images/person_1.jpg') }}" alt="Image"
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_6_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start"><img
                                            src="{{ asset('blogy/images/person_2.jpg') }}" alt="Image"
                                            class="img-fluid"></figure>
                                    <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                    <span>&nbsp;-&nbsp; July 19, 2019</span>
                                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_5_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_4_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start"><img
                                            src="{{ asset('blogy/images/person_4.jpg') }}" alt="Image"
                                            class="img-fluid"></figure>
                                    <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                    <span>&nbsp;-&nbsp; July 19, 2019</span>
                                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_3_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start"><img
                                            src="{{ asset('blogy/images/person_5.jpg') }}" alt="Image"
                                            class="img-fluid"></figure>
                                    <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                    <span>&nbsp;-&nbsp; July 19, 2019</span>
                                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_2_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="post-entry-alt">
                            <a href="single.html" class="img-link"><img
                                    src="{{ asset('blogy/images/img_1_horizontal.jpg') }}" alt="Image"
                                    class="img-fluid"></a>
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 me-3 float-start"><img
                                            src="{{ asset('blogy/images/person_3.jpg') }}" alt="Image"
                                            class="img-fluid"></figure>
                                    <span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
                                    <span>&nbsp;-&nbsp; July 19, 2019</span>
                                </div>
                ...
                <div class="row align-items-stretch retro-layout-alt">
                    ...
                    <div class="col-md-5 order-md-2">
                        <a href="single.html" class="hentry img-1 h-100 gradient">
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_2_vertical.jpg') }}');">
                            </div>
                            <div class="text">
                    ...
                    <div class="col-md-7">
                        ...
                        <a href="single.html" class="hentry img-2 v-height mb30 gradient">
                            <div class="featured-img"
                                style="background-image: url('{{ asset('blogy/images/img_1_horizontal.jpg') }}');">
                            </div>
                        ...
                        <div class="two-col d-block d-md-flex justify-content-between">
                            <a href="single.html" class="hentry v-height img-2 gradient">
                                <div class="featured-img"
                                    style="background-image: url('{{ asset('blogy/images/img_2_sq.jpg') }} }}');">
                                </div>
                                <div class="text text-sm">
                                    <span>February 12, 2019</span>
                                    <h2>Don’t assume your user data in the cloud is safe</h2>
                            ...
                            <a href="single.html" class="hentry v-height img-2 ms-auto float-end gradient">
                                <div class="featured-img"
                                    style="background-image: url('{{ asset('blogy/images/img_3_sq.jpg') }}');"></div>
                                <div class="text text-sm">
                                    <span>February 12, 2019</span>
                                    <h2>Startup vs corporate: What job suits you best?</h2>
                                </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="post-entry-footer">
                                <ul>
                                    <li>
                                        <a href="">
                                            <img src="{{ asset('blogy/images/img_1_sq.jpg') }}"
                                    ...
                                    <li>
                                        <a href="">
                                            <img src="{{ asset('blogy/images/img_2_sq.jpg') }}"
                                                alt="Image placeholder" class="me-4 rounded">
                                            <div class="text">
                                                <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                <div class="post-meta">
                                    ...
                                    <li>
                                        <a href="">
                                            <img src="{{ asset('blogy/images/img_3_sq.jpg') }}"
                                                alt="Image placeholder" class="me-4 rounded">
                                            <div class="text">
                                                <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                <div class="post-meta">
