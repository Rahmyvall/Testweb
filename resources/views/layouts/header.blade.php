...
<html lang="en">
    ...
    <head>
        ...
        <title>Test Wb & IT Sport | {{ $title }} </title>
        <!-- Simple bar CSS -->
        ...
        <link rel="stylesheet" href="{{ asset('tinydash/dark/css/daterangepicker.css') }}">
        <!-- App CSS -->
        <link rel="stylesheet" href="{{ asset('tinydash/dark/css/app-light.css') }}" id="lightTheme" disabled>
